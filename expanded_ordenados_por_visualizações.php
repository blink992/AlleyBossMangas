...
<body>
    <?php
        ...
        $index = 0;
            ...
            if($index > $colocacao_do_manga-1){
            
                $id_manga = $manga['ID']."expanded_ordenados_por_views";
            ...
            <div style="z-index:4" class="floating-btn-pagina-navbar">
                ...
                <div id="opcoes_manga'.$manga['ID'].'" style="width:max-content;height:58px;right:60px;top:37px;display:flex;flex-direction:row;z-index:-5;opacity:0;position:absolute;transition: opacity 0.5s, top 0.5s, transform 0.8s;transform: scale(0.5)">
                    ...
                    <li style="list-style: none; margin-left:12px">
                        <a onclick="addFavoritos('.$manga['ID'].','."'expanded_ordenados_por_views'".')" style="background-color: rgb(18, 45, 70)" id="favoritar-pagina-manga" class="btn btn-floating hoverable">
                            <i id="icon_favorite'. $manga['ID'].'expanded_ordenados_por_views" class="material-icons">
                                '.$icon.'
                            </i>
                        </a>  
                    </li>
