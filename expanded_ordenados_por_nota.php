    ...
    <?php
        ...
        while(($manga = $ranqueados->fetch_array()) and ($index < $dados)) {
            ...
            if($index > $colocacao_do_manga-1){
                ...
                $id_manga = $manga['ID']."expanded_ordenados_por_nota";
            ...
            echo '
                <div id="ex" style="width:100%;height:100%;margin-bottom:0px;margin-top:7px;box-shadow:none" class="card transparent">
