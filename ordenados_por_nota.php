...
$consulta = "SELECT * FROM mangas ORDER BY Nota DESC";
    ...
    <div style="width: 100%;height:max-content;display:flex;justify-content:space-evenly;flex-direction: row;padding-bottom:50px">
        ...
        <div style="display:flex;justify-content:center;flex-direction:column;" class="menu-ranqueado-pagina-navbar">
            <div style="order:-10;border-color:rgba(0,0,0,0);display:flex;justify-content: center;flex-direction:row" class="seção-header-pagina-navbar  ">
                <span style="font-size:inherit;order:1;position:relative" class="titulo-pagina-navbar center basic-text">Melhores Notas</span>
            ...
            <div class="z-depth-0">
                <li style="list-style: none;width: 100%;height: 100%;position: relative;">
                        ...
                        <div id="expanded_list" style="display: flex;flex-direction:column;justify-content:space-between;position:relative" class="expanded_ordenados_por_nota">
                            
                        </div>
                        
                        <i id="btn-expand-list" onclick="expand_list('expanded_ordenados_por_nota.php')" style="margin:18px;cursor: pointer;color:rgba(146, 163, 197, 1);font-size:165%;align-self:center;position:relative;width:98%" class="center fa-solid fa-chevron-down"></i>
